...
export class Init1718648797525 implements MigrationInterface {
    name = 'Init1718648797525'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`audits\` ADD CONSTRAINT \`FK_75815d96a3c33cd4f690b2b1fa1\` FOREIGN KEY (\`id_level\`) REFERENCES \`template\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }
